var EMAILS = [
  // ── 1. Microsoft MFA (PHISHING) ──────────────────────────
  {
    ...
    to: "l.steiner@edu.zh.ch", // Neue Domain!
    ...
    body: `
      <div style="font-family:'Segoe UI',Arial,sans-serif;font-size:14px;color:#333;">
        ...
        <p>Wir haben eine ungewöhnliche Anmeldung bei Ihrem Konto l.steiner@edu.zh.ch festgestellt.</p>
  ...
  // ── 2. IT Support / Speicherplatz (PHISHING) ──────────────────────────
  {
    ...
    senderLegit: "support@edu.zh.ch",
    to: "l.steiner@edu.zh.ch",
    subject: "DRINGEND: Ihr Postfach ist fast voll",
    date: "Mo, 1. Juni 2026  14:12",
    linkLabel: "Speicherplatz erweitern",
    linkUrl: "http://edu.zh.ch.quota-upgrade.info",
    linkIsPhishing: true,
    body: `
      <div style="font-family:Arial,sans-serif;font-size:14px;color:#333;">
        <p>Hallo,</p>
        <p>Ihr E-Mail-Postfach (l.steiner@edu.zh.ch) hat sein Limit von 2 GB fast erreicht (99% voll).</p>
